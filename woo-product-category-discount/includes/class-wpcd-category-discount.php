...
class WPCD_Category_Discount {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wpcd-category-discount-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wpcd-category-discount-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wpcd-category-discount-admin.php';

		/**
		 * The class responsible for defining all core list table functionality.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wpcd-list-table.php';

		/**
		 * The class responsible for all the discount list table functionality.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wpcd-category-discount-list-table.php';
		
		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-wpcd-category-discount-public.php';

		/**
		 * The class responsible for all migration related features.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wpcd-category-discount-migrate-legacy.php';
	...
	private function set_locale() {
		...
		$plugin_i18n = new WPCD_Category_Discount_i18n();
